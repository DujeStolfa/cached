...
class _NewTransferScreenState extends State<NewTransferScreen> {
  ...
  // Osiguraj ispravnost unesenih podataka i dodaj transfer u bazu podataka
  ...
  // Postavi izbornik za odabir novčanika pošiljatelja
  ...
  // Postavi izbornik za odabir novčanika primatelja
  ...
  // Otvori izbornik za odabir datuma transfera
  ...
  Widget build(BuildContext context) {
    ...
    // Dohvati listu svih korisnikovih novčanika
    _wallets = walletsSnapshot.docs
        .map((element) => model.createWallet(element.data()))
        .toList();

    // Dohvati listu svih korisnikovih kategorija
                              ...
                              Row(
                                children: [
                                  ...
                                  (_selectedReceiverWallet != null)
                                      ...
                                      : () {
                                          _selectedReceiverWallet = _wallets[1];
